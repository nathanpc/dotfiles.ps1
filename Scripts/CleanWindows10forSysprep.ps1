# CleanWindows10forSysprep.ps1
# Cleans up a Windows installation for creating a system image.
# Based on the work of: Disassembler <disassembler@dasm.cz> and Craft Computing.
#
...
Write-Output "Disabling reinstallation of default Windows and third-party applications..."
$cdm = @(
...
Write-Output "Disabling unwanted Windows services..."
$services = @(
...
# Optimize Windows updates by disabling automatic download and seeding updates to other computers.
...
Write-Output "Waiting for Windows Explorer to reload..."
Start-Sleep 10
...
# Note: DMWAPPUSHSERVICE is a Keyboard and Ink telemetry service, and potential keylogger. It is recommended to disable this service
# in new builds, but SYSPREP will freeze/fail if the service is not running. If SYSPREP will be used, add a FirstBootCommand to your
